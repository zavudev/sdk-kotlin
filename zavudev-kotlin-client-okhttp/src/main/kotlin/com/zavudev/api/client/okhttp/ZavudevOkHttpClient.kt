...
import com.zavudev.api.client.ZavudevClientImpl
...
/**
 * A class that allows building an instance of [ZavudevClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class ZavudevOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [ZavudevClient]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): ZavudevClient = builder().fromEnv().build()
    }

    /** A builder for [ZavudevOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ZavudevClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ZavudevClient =
            ZavudevClientImpl(
                clientOptions
                    .httpClient(
