...
package com.zavudev.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.zavudev.api.client.ZavudevClientAsync
import com.zavudev.api.client.ZavudevClientAsyncImpl
import com.zavudev.api.core.ClientOptions
import com.zavudev.api.core.LogLevel
import com.zavudev.api.core.Sleeper
import com.zavudev.api.core.Timeout
...
/**
 * A class that allows building an instance of [ZavudevClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class ZavudevOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [ZavudevClientAsync]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): ZavudevClientAsync = builder().fromEnv().build()
    }

    /** A builder for [ZavudevOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ZavudevClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ZavudevClientAsync =
            ZavudevClientAsyncImpl(
                clientOptions
                    .httpClient(
