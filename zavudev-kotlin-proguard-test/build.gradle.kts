...
dependencies {
    testImplementation(project(":zavudev-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../zavudev-kotlin-core/src/main/resources/META-INF/proguard/zavudev-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.zavudev.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../zavudev-kotlin-core/src/main/resources/META-INF/proguard/zavudev-kotlin-core.pro",
