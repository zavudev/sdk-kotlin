...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.zavudev.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.zavudev.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.zavudev.api.** {
    <init>(...);
