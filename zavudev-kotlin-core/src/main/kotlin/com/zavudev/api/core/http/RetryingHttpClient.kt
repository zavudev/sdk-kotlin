...
package com.zavudev.api.core.http

import com.zavudev.api.core.DefaultSleeper
import com.zavudev.api.core.RequestOptions
import com.zavudev.api.core.Sleeper
import com.zavudev.api.core.checkRequired
import com.zavudev.api.errors.ZavudevIoException
import com.zavudev.api.errors.ZavudevRetryableException
...
private constructor(
    ...
    private fun shouldRetry(throwable: Throwable): Boolean =
        ...
        throwable is IOException ||
            throwable is ZavudevIoException ||
            throwable is ZavudevRetryableException
