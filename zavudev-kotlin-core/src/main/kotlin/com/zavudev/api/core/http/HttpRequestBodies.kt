...
import com.zavudev.api.core.MultipartField
...
private fun serializePart(name: String, node: JsonNode): Sequence<Pair<String, InputStream>> =
    when (node.nodeType) {
                    ...
                    node
                        ...
                        .mapNotNull { element ->
                            when (element.nodeType) {
                                ...
                                JsonNodeType.OBJECT,
                                JsonNodeType.POJO ->
                                    throw ZavudevInvalidDataException(
        ...
        JsonNodeType.POJO,
        null -> throw ZavudevInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
    }
