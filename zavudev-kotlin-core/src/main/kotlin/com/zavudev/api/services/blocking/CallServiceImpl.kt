...
class CallServiceImpl internal constructor(private val clientOptions: ClientOptions) : CallService {
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): CallService =
        CallServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            CallServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())
