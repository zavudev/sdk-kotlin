...
class TemplateServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): TemplateService =
        TemplateServiceImpl(clientOptions.toBuilder().apply(modifier).build())

    override fun create(params: TemplateCreateParams, requestOptions: RequestOptions): Template =
        // post /v1/templates
    ...
    override fun submit(params: TemplateSubmitParams, requestOptions: RequestOptions): Template =
