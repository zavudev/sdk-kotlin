...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ApiKeyListParams =
            ApiKeyListParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ApiKeyListParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
