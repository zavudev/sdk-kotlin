...
private constructor(
    ...
    companion object {
        ...
        fun none(): SubAccountUpdateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SubAccountUpdateParams]. */
        fun builder() = Builder()
    }

    /** A builder for [SubAccountUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(subAccountUpdateParams: SubAccountUpdateParams) = apply {
            id = subAccountUpdateParams.id
            body = subAccountUpdateParams.body.toBuilder()
            additionalHeaders = subAccountUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = subAccountUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SubAccountUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SubAccountUpdateParams =
    ...
    private constructor(
        ...
        ) : this(creditLimit, externalId, metadata, name, status, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(creditLimit, externalId, metadata, name, status, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{creditLimit=$creditLimit, externalId=$externalId, metadata=$metadata, name=$name, status=$status, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubAccountUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "SubAccountUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
