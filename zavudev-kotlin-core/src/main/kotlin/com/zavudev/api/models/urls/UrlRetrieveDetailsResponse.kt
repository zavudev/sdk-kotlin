...
class UrlRetrieveDetailsResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UrlRetrieveDetailsResponse].
         *
    ...
    /** A builder for [UrlRetrieveDetailsResponse]. */
    class Builder internal constructor() {

        private var url: JsonField<VerifiedUrl>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(urlRetrieveDetailsResponse: UrlRetrieveDetailsResponse) = apply {
            url = urlRetrieveDetailsResponse.url
            additionalProperties = urlRetrieveDetailsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UrlRetrieveDetailsResponse].
         *
         ...
         */
        fun build(): UrlRetrieveDetailsResponse =
     ...
     *   expected type.
     */
    fun validate(): UrlRetrieveDetailsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UrlRetrieveDetailsResponse &&
            url == other.url &&
    ...
    override fun toString() =
        "UrlRetrieveDetailsResponse{url=$url, additionalProperties=$additionalProperties}"
}
