...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SenderConnectResponse].
         *
    ...
    /** A builder for [SenderConnectResponse]. */
    class Builder internal constructor() {

        private var agent: JsonField<Agent>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(senderConnectResponse: SenderConnectResponse) = apply {
            agent = senderConnectResponse.agent
            additionalProperties = senderConnectResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SenderConnectResponse].
         *
         ...
         */
        fun build(): SenderConnectResponse =
     ...
     *   expected type.
     */
    fun validate(): SenderConnectResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SenderConnectResponse &&
            agent == other.agent &&
    ...
    override fun toString() =
        "SenderConnectResponse{agent=$agent, additionalProperties=$additionalProperties}"
}
