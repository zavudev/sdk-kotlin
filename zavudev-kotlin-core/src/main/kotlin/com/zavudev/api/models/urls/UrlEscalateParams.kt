...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UrlEscalateParams].
         *
    ...
    /** A builder for [UrlEscalateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(urlEscalateParams: UrlEscalateParams) = apply {
            urlId = urlEscalateParams.urlId
            body = urlEscalateParams.body.toBuilder()
            additionalHeaders = urlEscalateParams.additionalHeaders.toBuilder()
            additionalQueryParams = urlEscalateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UrlEscalateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UrlEscalateParams &&
            urlId == other.urlId &&
            body == other.body &&
    ...
    override fun hashCode(): Int =
        Objects.hash(urlId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "UrlEscalateParams{urlId=$urlId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
