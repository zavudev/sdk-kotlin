...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailDomainListResponse].
         *
    ...
    /** A builder for [EmailDomainListResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<Item>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(emailDomainListResponse: EmailDomainListResponse) = apply {
            items = emailDomainListResponse.items.map { it.toMutableList() }
            additionalProperties = emailDomainListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailDomainListResponse].
         *
         ...
         */
        fun build(): EmailDomainListResponse =
     ...
     *   expected type.
     */
    fun validate(): EmailDomainListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(item: Item) = apply {
                id = item.id
                dkimStatus = item.dkimStatus
                domain = item.domain
                status = item.status
                dnsRecords = item.dnsRecords.map { it.toMutableList() }
        ...
        override fun toString() =
            "Item{id=$id, dkimStatus=$dkimStatus, domain=$domain, status=$status, dnsRecords=$dnsRecords, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailDomainListResponse &&
            items == other.items &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "EmailDomainListResponse{items=$items, additionalProperties=$additionalProperties}"
}
