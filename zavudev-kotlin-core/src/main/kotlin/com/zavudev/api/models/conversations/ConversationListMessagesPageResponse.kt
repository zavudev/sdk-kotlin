...
class ConversationListMessagesPageResponse
...
private constructor(
    ...
    /** A builder for [ConversationListMessagesPageResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            items = conversationListMessagesPageResponse.items.map { it.toMutableList() }
            nextCursor = conversationListMessagesPageResponse.nextCursor
            additionalProperties =
                conversationListMessagesPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConversationListMessagesPageResponse].
         *
         ...
         */
        fun build(): ConversationListMessagesPageResponse =
            ConversationListMessagesPageResponse(
     ...
     *   expected type.
     */
    fun validate(): ConversationListMessagesPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConversationListMessagesPageResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "ConversationListMessagesPageResponse{items=$items, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
