...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(documentListParams: DocumentListParams) = apply {
            senderId = documentListParams.senderId
            kbId = documentListParams.kbId
    ...
    override fun hashCode(): Int =
        Objects.hash(senderId, kbId, cursor, limit, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "DocumentListParams{senderId=$senderId, kbId=$kbId, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
