...
class FunctionGetDeploymentResponse
...
private constructor(
    ...
    /** A builder for [FunctionGetDeploymentResponse]. */
    class Builder internal constructor() {

        private var deployment: JsonField<Deployment>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(functionGetDeploymentResponse: FunctionGetDeploymentResponse) = apply {
            deployment = functionGetDeploymentResponse.deployment
            additionalProperties = functionGetDeploymentResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FunctionGetDeploymentResponse].
         *
         ...
         */
        fun build(): FunctionGetDeploymentResponse =
            FunctionGetDeploymentResponse(
     ...
     *   expected type.
     */
    fun validate(): FunctionGetDeploymentResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FunctionGetDeploymentResponse &&
    ...
    override fun toString() =
        "FunctionGetDeploymentResponse{deployment=$deployment, additionalProperties=$additionalProperties}"
}
