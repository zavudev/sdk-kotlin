...
private constructor(
    ...
    /**
     * Voice Agent configuration. Enable this to let the agent answer and place phone calls with
     * Zavu's managed voice pipeline. Requires the Voice Agents feature to be enabled for your team.
     *
     * @throws ZavudevInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(agentCreateParams: AgentCreateParams) = apply {
            senderId = agentCreateParams.senderId
        ...
        /**
         * Voice Agent configuration. Enable this to let the agent answer and place phone calls with
         * Zavu's managed voice pipeline. Requires the Voice Agents feature to be enabled for your
         * team.
         */
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /**
             * Voice Agent configuration. Enable this to let the agent answer and place phone calls
             * with Zavu's managed voice pipeline. Requires the Voice Agents feature to be enabled
             * for your team.
             */
        ...
        override fun toString() =
            "Body{model=$model, name=$name, provider=$provider, systemPrompt=$systemPrompt, apiKey=$apiKey, contextWindowMessages=$contextWindowMessages, includeContactMetadata=$includeContactMetadata, maxTokens=$maxTokens, temperature=$temperature, triggerOnChannels=$triggerOnChannels, triggerOnMessageTypes=$triggerOnMessageTypes, voice=$voice, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "AgentCreateParams{senderId=$senderId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
