...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): BrandListParams =
            BrandListParams(cursor, limit, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "BrandListParams{cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
