...
class PhoneNumberRetrieveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PhoneNumberRetrieveResponse].
         *
    ...
    /** A builder for [PhoneNumberRetrieveResponse]. */
    class Builder internal constructor() {

        private var phoneNumber: JsonField<OwnedPhoneNumber>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(phoneNumberRetrieveResponse: PhoneNumberRetrieveResponse) = apply {
            phoneNumber = phoneNumberRetrieveResponse.phoneNumber
            additionalProperties = phoneNumberRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PhoneNumberRetrieveResponse].
         *
         ...
         */
        fun build(): PhoneNumberRetrieveResponse =
     ...
     *   expected type.
     */
    fun validate(): PhoneNumberRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberRetrieveResponse &&
    ...
    override fun toString() =
        "PhoneNumberRetrieveResponse{phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
