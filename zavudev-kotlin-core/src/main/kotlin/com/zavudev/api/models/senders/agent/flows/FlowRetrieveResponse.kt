...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FlowRetrieveResponse].
         *
    ...
    /** A builder for [FlowRetrieveResponse]. */
    class Builder internal constructor() {

        private var flow: JsonField<AgentFlow>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(flowRetrieveResponse: FlowRetrieveResponse) = apply {
            flow = flowRetrieveResponse.flow
            additionalProperties = flowRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FlowRetrieveResponse].
         *
         ...
         */
        fun build(): FlowRetrieveResponse =
            FlowRetrieveResponse(checkRequired("flow", flow), additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): FlowRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FlowRetrieveResponse &&
            flow == other.flow &&
    ...
    override fun toString() =
        "FlowRetrieveResponse{flow=$flow, additionalProperties=$additionalProperties}"
}
