...
class WhatsappSyncStartContactsSyncResponse
...
private constructor(
    ...
    /** A builder for [WhatsappSyncStartContactsSyncResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            message = whatsappSyncStartContactsSyncResponse.message
            sync = whatsappSyncStartContactsSyncResponse.sync
            additionalProperties =
                whatsappSyncStartContactsSyncResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WhatsappSyncStartContactsSyncResponse].
         *
         ...
         */
        fun build(): WhatsappSyncStartContactsSyncResponse =
            WhatsappSyncStartContactsSyncResponse(
     ...
     *   expected type.
     */
    fun validate(): WhatsappSyncStartContactsSyncResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhatsappSyncStartContactsSyncResponse &&
    ...
    override fun toString() =
        "WhatsappSyncStartContactsSyncResponse{message=$message, sync=$sync, additionalProperties=$additionalProperties}"
}
