...
class BroadcastRescheduleParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BroadcastRescheduleParams].
         *
    ...
    /** A builder for [BroadcastRescheduleParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(broadcastRescheduleParams: BroadcastRescheduleParams) = apply {
            broadcastId = broadcastRescheduleParams.broadcastId
            body = broadcastRescheduleParams.body.toBuilder()
            additionalHeaders = broadcastRescheduleParams.additionalHeaders.toBuilder()
            additionalQueryParams = broadcastRescheduleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BroadcastRescheduleParams].
         *
         ...
         */
        fun build(): BroadcastRescheduleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BroadcastRescheduleParams &&
    ...
    override fun toString() =
        "BroadcastRescheduleParams{broadcastId=$broadcastId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
