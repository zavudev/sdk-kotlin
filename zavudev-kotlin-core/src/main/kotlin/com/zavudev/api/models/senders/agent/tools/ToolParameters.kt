...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun required(): List<String> = required.getRequired("required")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ToolParameters].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(toolParameters: ToolParameters) = apply {
            properties = toolParameters.properties
            required = toolParameters.required.map { it.toMutableList() }
            type = toolParameters.type
            additionalProperties = toolParameters.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ToolParameters].
         *
        ...
        fun build(): ToolParameters =
            ToolParameters(
                ...
                checkRequired("required", required).map { it.toImmutable() },
     ...
     *   expected type.
     */
    fun validate(): ToolParameters = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ToolParameters &&
    ...
    override fun toString() =
        "ToolParameters{properties=$properties, required=$required, type=$type, additionalProperties=$additionalProperties}"
}
