...
class PhoneNumberStatus @JsonCreator private constructor(private val value: JsonField<String>) :
    ...
    /** An enum containing [PhoneNumberStatus]'s known values. */
    enum class Known {
        ACTIVE,
        SUSPENDED,
        PENDING,
    ...
    /**
     * An enum containing [PhoneNumberStatus]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [PhoneNumberStatus] can contain an unknown value in a couple of cases:
     ...
     *   expected type.
     */
    fun validate(): PhoneNumberStatus = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberStatus && value == other.value
    }
