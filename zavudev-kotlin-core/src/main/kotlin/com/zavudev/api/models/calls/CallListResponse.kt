...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("endReason") @ExcludeMissing endReason: JsonField<String> = JsonMissing.of(),
        @JsonProperty("metadata") @ExcludeMissing metadata: JsonField<Metadata> = JsonMissing.of(),
        @JsonProperty("transcript")
        @ExcludeMissing
        transcript: JsonField<List<Transcript>> = JsonMissing.of(),
        @JsonProperty("turnCount") @ExcludeMissing turnCount: JsonField<Long> = JsonMissing.of(),
    ...
    /**
     * Caller phone number in E.164 format. Your sender's number for outbound calls; the caller's
    ...
    /**
     * Why the call ended (e.g. `agent_ended`, `max_duration`, `transfer`, `hangup`). Present once
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CallListResponse].
         *
    ...
    /** A builder for [CallListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(callListResponse: CallListResponse) = apply {
            id = callListResponse.id
            createdAt = callListResponse.createdAt
            direction = callListResponse.direction
            from = callListResponse.from
            status = callListResponse.status
            to = callListResponse.to
            answeredAt = callListResponse.answeredAt
            cost = callListResponse.cost
            durationSeconds = callListResponse.durationSeconds
            endedAt = callListResponse.endedAt
            endReason = callListResponse.endReason
            metadata = callListResponse.metadata
            transcript = callListResponse.transcript.map { it.toMutableList() }
            turnCount = callListResponse.turnCount
            updatedAt = callListResponse.updatedAt
         ...
         *
         * You should usually call [Builder.durationSeconds] with a well-typed [Long] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.transcript] with a well-typed `List<Transcript>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.turnCount] with a well-typed [Long] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        ...
        /**
         * Returns an immutable instance of [CallListResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): CallListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        /**
         * Transcribed speech for `user` and `assistant` turns, or a JSON summary of the tool call
         * for `tool` turns.
         *
         * @throws ZavudevInvalidDataException if the JSON field has an unexpected type or is
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallListResponse &&
            id == other.id &&
