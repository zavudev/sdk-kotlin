...
class InvitationCancelResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InvitationCancelResponse].
         *
    ...
    /** A builder for [InvitationCancelResponse]. */
    class Builder internal constructor() {

        private var invitation: JsonField<Invitation>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(invitationCancelResponse: InvitationCancelResponse) = apply {
            invitation = invitationCancelResponse.invitation
            additionalProperties = invitationCancelResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InvitationCancelResponse].
         *
         ...
         */
        fun build(): InvitationCancelResponse =
     ...
     *   expected type.
     */
    fun validate(): InvitationCancelResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvitationCancelResponse &&
    ...
    override fun toString() =
        "InvitationCancelResponse{invitation=$invitation, additionalProperties=$additionalProperties}"
}
