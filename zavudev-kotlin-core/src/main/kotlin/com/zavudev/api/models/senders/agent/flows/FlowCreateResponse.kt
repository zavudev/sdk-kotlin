...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FlowCreateResponse].
         *
    ...
    /** A builder for [FlowCreateResponse]. */
    class Builder internal constructor() {

        private var flow: JsonField<AgentFlow>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(flowCreateResponse: FlowCreateResponse) = apply {
            flow = flowCreateResponse.flow
            additionalProperties = flowCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FlowCreateResponse].
         *
         ...
         */
        fun build(): FlowCreateResponse =
            FlowCreateResponse(checkRequired("flow", flow), additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): FlowCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FlowCreateResponse &&
            flow == other.flow &&
    ...
    override fun toString() =
        "FlowCreateResponse{flow=$flow, additionalProperties=$additionalProperties}"
}
