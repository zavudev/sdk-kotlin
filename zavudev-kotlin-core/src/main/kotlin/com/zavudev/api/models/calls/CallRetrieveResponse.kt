...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): CallRetrieveResponse =
            CallRetrieveResponse(checkRequired("call", call), additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "CallRetrieveResponse{call=$call, additionalProperties=$additionalProperties}"
}
