...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GitLinkRetrieveResponse].
         *
    ...
    /** A builder for [GitLinkRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(gitLinkRetrieveResponse: GitLinkRetrieveResponse) = apply {
            link = gitLinkRetrieveResponse.link
            webhookUrl = gitLinkRetrieveResponse.webhookUrl
            webhookSecret = gitLinkRetrieveResponse.webhookSecret
            additionalProperties = gitLinkRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GitLinkRetrieveResponse].
         *
         ...
         */
        fun build(): GitLinkRetrieveResponse =
     ...
     *   expected type.
     */
    fun validate(): GitLinkRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GitLinkRetrieveResponse &&
            link == other.link &&
    ...
    override fun toString() =
        "GitLinkRetrieveResponse{link=$link, webhookUrl=$webhookUrl, webhookSecret=$webhookSecret, additionalProperties=$additionalProperties}"
}
