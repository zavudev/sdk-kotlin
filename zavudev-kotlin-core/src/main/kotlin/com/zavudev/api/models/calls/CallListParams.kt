...
private constructor(
    ...
    companion object {
        ...
        fun none(): CallListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(callListParams: CallListParams) = apply {
            cursor = callListParams.cursor
            direction = callListParams.direction
            limit = callListParams.limit
    ...
    override fun hashCode(): Int =
        Objects.hash(cursor, direction, limit, status, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "CallListParams{cursor=$cursor, direction=$direction, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
