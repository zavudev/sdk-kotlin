...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChannelUpdateResponse].
         *
    ...
    /** A builder for [ChannelUpdateResponse]. */
    class Builder internal constructor() {

        private var channel: JsonField<ContactChannel>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(channelUpdateResponse: ChannelUpdateResponse) = apply {
            channel = channelUpdateResponse.channel
            additionalProperties = channelUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChannelUpdateResponse].
         *
         ...
         */
        fun build(): ChannelUpdateResponse =
     ...
     *   expected type.
     */
    fun validate(): ChannelUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChannelUpdateResponse &&
    ...
    override fun toString() =
        "ChannelUpdateResponse{channel=$channel, additionalProperties=$additionalProperties}"
}
