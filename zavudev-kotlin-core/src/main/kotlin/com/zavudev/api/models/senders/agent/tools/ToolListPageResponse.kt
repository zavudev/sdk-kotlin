...
private constructor(
    private val items: JsonField<List<AgentTool>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("items") @ExcludeMissing items: JsonField<List<AgentTool>> = JsonMissing.of(),
     ...
     */
    fun items(): List<AgentTool> = items.getRequired("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<AgentTool>> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: JsonField<MutableList<AgentTool>>? = null
        ...
        internal fun from(toolListPageResponse: ToolListPageResponse) = apply {
            ...
            nextCursor = toolListPageResponse.nextCursor
            additionalProperties = toolListPageResponse.additionalProperties.toMutableMap()
        }

        fun items(items: List<AgentTool>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<AgentTool>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<AgentTool>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [AgentTool] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: AgentTool) = apply {
            items =
    ...
    override fun toString() =
        "ToolListPageResponse{items=$items, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
