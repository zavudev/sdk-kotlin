...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrandSubmitResponse].
         *
    ...
    /** A builder for [BrandSubmitResponse]. */
    class Builder internal constructor() {

        private var brand: JsonField<TenDlcBrand>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(brandSubmitResponse: BrandSubmitResponse) = apply {
            brand = brandSubmitResponse.brand
            additionalProperties = brandSubmitResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrandSubmitResponse].
         *
         ...
         */
        fun build(): BrandSubmitResponse =
            BrandSubmitResponse(checkRequired("brand", brand), additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrandSubmitResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrandSubmitResponse &&
            brand == other.brand &&
    ...
    override fun toString() =
        "BrandSubmitResponse{brand=$brand, additionalProperties=$additionalProperties}"
}
