...
private constructor(
...
) : PageAsync<AgentDocument> {

    /**
     * Delegates to [DocumentListPageResponse], but gracefully handles missing data.
     *
     * @see DocumentListPageResponse.items
     */
    override fun items(): List<AgentDocument> =
    ...
    fun autoPager(): AutoPagerAsync<AgentDocument> = AutoPagerAsync.from(this)
