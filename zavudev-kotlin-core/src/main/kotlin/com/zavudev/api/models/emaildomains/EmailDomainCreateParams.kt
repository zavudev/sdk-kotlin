...
/**
 * Add a domain to send email from. Returns the DNS records to publish (DKIM CNAMEs are required;
 * SPF, DMARC, and MAIL FROM are recommended). Publish them at your DNS provider, then verify.
 */
...
private constructor(
    ...
    private constructor(
         ...
         */
        internal fun validity(): Int = (if (domain.asKnown() == null) 0 else 1)
