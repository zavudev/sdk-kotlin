...
class FunctionRetrieveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FunctionRetrieveResponse].
         *
    ...
    /** A builder for [FunctionRetrieveResponse]. */
    class Builder internal constructor() {

        private var function: JsonField<Function>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(functionRetrieveResponse: FunctionRetrieveResponse) = apply {
            function = functionRetrieveResponse.function
            additionalProperties = functionRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FunctionRetrieveResponse].
         *
         ...
         */
        fun build(): FunctionRetrieveResponse =
     ...
     *   expected type.
     */
    fun validate(): FunctionRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FunctionRetrieveResponse &&
    ...
    override fun toString() =
        "FunctionRetrieveResponse{function=$function, additionalProperties=$additionalProperties}"
}
