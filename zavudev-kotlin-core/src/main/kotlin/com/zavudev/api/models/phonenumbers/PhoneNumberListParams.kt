...
private constructor(
    ...
    private val status: PhoneNumberStatus?,
    ...
    fun status(): PhoneNumberStatus? = status
    ...
    companion object {
        ...
        fun none(): PhoneNumberListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        private var status: PhoneNumberStatus? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(phoneNumberListParams: PhoneNumberListParams) = apply {
            cursor = phoneNumberListParams.cursor
            limit = phoneNumberListParams.limit
            status = phoneNumberListParams.status
        ...
        /** Filter by phone number status. */
        fun status(status: PhoneNumberStatus?) = apply { this.status = status }
    ...
    override fun toString() =
        "PhoneNumberListParams{cursor=$cursor, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
