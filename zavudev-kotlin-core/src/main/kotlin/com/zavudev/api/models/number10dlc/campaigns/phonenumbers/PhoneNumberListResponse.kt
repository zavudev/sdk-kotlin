...
private constructor(
    private val items: JsonField<List<TenDlcPhoneNumberAssignment>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<TenDlcPhoneNumberAssignment>> = JsonMissing.of(),
     ...
     */
    fun items(): List<TenDlcPhoneNumberAssignment> = items.getRequired("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<TenDlcPhoneNumberAssignment>> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: JsonField<MutableList<TenDlcPhoneNumberAssignment>>? = null
        private var nextCursor: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(phoneNumberListResponse: PhoneNumberListResponse) = apply {
            items = phoneNumberListResponse.items.map { it.toMutableList() }
            nextCursor = phoneNumberListResponse.nextCursor
            additionalProperties = phoneNumberListResponse.additionalProperties.toMutableMap()
        }

        fun items(items: List<TenDlcPhoneNumberAssignment>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed
         * `List<TenDlcPhoneNumberAssignment>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun items(items: JsonField<List<TenDlcPhoneNumberAssignment>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [TenDlcPhoneNumberAssignment] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: TenDlcPhoneNumberAssignment) = apply {
            items =
    ...
    override fun toString() =
        "PhoneNumberListResponse{items=$items, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
