...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BroadcastCreateResponse].
         *
    ...
    /** A builder for [BroadcastCreateResponse]. */
    class Builder internal constructor() {

        private var broadcast: JsonField<Broadcast>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(broadcastCreateResponse: BroadcastCreateResponse) = apply {
            broadcast = broadcastCreateResponse.broadcast
            additionalProperties = broadcastCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BroadcastCreateResponse].
         *
         ...
         */
        fun build(): BroadcastCreateResponse =
     ...
     *   expected type.
     */
    fun validate(): BroadcastCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BroadcastCreateResponse &&
    ...
    override fun toString() =
        "BroadcastCreateResponse{broadcast=$broadcast, additionalProperties=$additionalProperties}"
}
