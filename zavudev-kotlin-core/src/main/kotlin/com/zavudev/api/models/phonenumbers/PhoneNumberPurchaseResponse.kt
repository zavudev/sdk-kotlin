...
class PhoneNumberPurchaseResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PhoneNumberPurchaseResponse].
         *
    ...
    /** A builder for [PhoneNumberPurchaseResponse]. */
    class Builder internal constructor() {

        private var phoneNumber: JsonField<OwnedPhoneNumber>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(phoneNumberPurchaseResponse: PhoneNumberPurchaseResponse) = apply {
            phoneNumber = phoneNumberPurchaseResponse.phoneNumber
            additionalProperties = phoneNumberPurchaseResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PhoneNumberPurchaseResponse].
         *
         ...
         */
        fun build(): PhoneNumberPurchaseResponse =
     ...
     *   expected type.
     */
    fun validate(): PhoneNumberPurchaseResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberPurchaseResponse &&
    ...
    override fun toString() =
        "PhoneNumberPurchaseResponse{phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
