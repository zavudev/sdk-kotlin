...
class BroadcastRescheduleResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BroadcastRescheduleResponse].
         *
    ...
    /** A builder for [BroadcastRescheduleResponse]. */
    class Builder internal constructor() {

        private var broadcast: JsonField<Broadcast>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(broadcastRescheduleResponse: BroadcastRescheduleResponse) = apply {
            broadcast = broadcastRescheduleResponse.broadcast
            additionalProperties = broadcastRescheduleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BroadcastRescheduleResponse].
         *
         ...
         */
        fun build(): BroadcastRescheduleResponse =
     ...
     *   expected type.
     */
    fun validate(): BroadcastRescheduleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BroadcastRescheduleResponse &&
    ...
    override fun toString() =
        "BroadcastRescheduleResponse{broadcast=$broadcast, additionalProperties=$additionalProperties}"
}
