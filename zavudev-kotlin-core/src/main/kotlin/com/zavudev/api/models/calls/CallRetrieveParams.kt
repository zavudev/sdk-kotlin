...
/**
 * Retrieve a single voice call, including its full transcript once the conversation has produced
 * turns.
 */
...
private constructor(
    ...
    companion object {
        ...
        fun none(): CallRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(callRetrieveParams: CallRetrieveParams) = apply {
            callId = callRetrieveParams.callId
        ...
        fun build(): CallRetrieveParams =
            CallRetrieveParams(callId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun hashCode(): Int = Objects.hash(callId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "CallRetrieveParams{callId=$callId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
