...
class DocumentUpdateDocumentResponse
...
private constructor(
    ...
    /** A builder for [DocumentUpdateDocumentResponse]. */
    class Builder internal constructor() {

        private var document: JsonField<AgentDocument>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(documentUpdateDocumentResponse: DocumentUpdateDocumentResponse) = apply {
            document = documentUpdateDocumentResponse.document
            additionalProperties =
                documentUpdateDocumentResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DocumentUpdateDocumentResponse].
         *
         ...
         */
        fun build(): DocumentUpdateDocumentResponse =
            DocumentUpdateDocumentResponse(
     ...
     *   expected type.
     */
    fun validate(): DocumentUpdateDocumentResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DocumentUpdateDocumentResponse &&
    ...
    override fun toString() =
        "DocumentUpdateDocumentResponse{document=$document, additionalProperties=$additionalProperties}"
}
