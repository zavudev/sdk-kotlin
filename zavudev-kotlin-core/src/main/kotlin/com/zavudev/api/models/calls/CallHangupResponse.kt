...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CallHangupResponse].
         *
    ...
    /** A builder for [CallHangupResponse]. */
    class Builder internal constructor() {

        private var call: JsonField<Call>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(callHangupResponse: CallHangupResponse) = apply {
            call = callHangupResponse.call
            additionalProperties = callHangupResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallHangupResponse].
         *
         ...
         */
        fun build(): CallHangupResponse =
            CallHangupResponse(checkRequired("call", call), additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): CallHangupResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallHangupResponse &&
            call == other.call &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallHangupResponse{call=$call, additionalProperties=$additionalProperties}"
}
