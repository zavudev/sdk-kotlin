...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CampaignSubmitResponse].
         *
    ...
    /** A builder for [CampaignSubmitResponse]. */
    class Builder internal constructor() {

        private var campaign: JsonField<TenDlcCampaign>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(campaignSubmitResponse: CampaignSubmitResponse) = apply {
            campaign = campaignSubmitResponse.campaign
            additionalProperties = campaignSubmitResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CampaignSubmitResponse].
         *
         ...
         */
        fun build(): CampaignSubmitResponse =
     ...
     *   expected type.
     */
    fun validate(): CampaignSubmitResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CampaignSubmitResponse &&
    ...
    override fun toString() =
        "CampaignSubmitResponse{campaign=$campaign, additionalProperties=$additionalProperties}"
}
