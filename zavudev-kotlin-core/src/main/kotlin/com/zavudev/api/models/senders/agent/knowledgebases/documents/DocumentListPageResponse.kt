...
private constructor(
    private val items: JsonField<List<AgentDocument>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<AgentDocument>> = JsonMissing.of(),
     ...
     */
    fun items(): List<AgentDocument> = items.getRequired("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<AgentDocument>> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: JsonField<MutableList<AgentDocument>>? = null
        private var nextCursor: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(documentListPageResponse: DocumentListPageResponse) = apply {
            items = documentListPageResponse.items.map { it.toMutableList() }
        ...
        fun items(items: List<AgentDocument>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<AgentDocument>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<AgentDocument>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [AgentDocument] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: AgentDocument) = apply {
            items =
    ...
    override fun toString() =
        "DocumentListPageResponse{items=$items, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
