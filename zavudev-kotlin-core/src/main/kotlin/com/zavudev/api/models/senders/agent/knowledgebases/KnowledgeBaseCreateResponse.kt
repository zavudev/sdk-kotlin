...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [KnowledgeBaseCreateResponse].
         *
    ...
    /** A builder for [KnowledgeBaseCreateResponse]. */
    class Builder internal constructor() {

        private var knowledgeBase: JsonField<AgentKnowledgeBase>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(knowledgeBaseCreateResponse: KnowledgeBaseCreateResponse) = apply {
            knowledgeBase = knowledgeBaseCreateResponse.knowledgeBase
            additionalProperties = knowledgeBaseCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [KnowledgeBaseCreateResponse].
         *
         ...
         */
        fun build(): KnowledgeBaseCreateResponse =
     ...
     *   expected type.
     */
    fun validate(): KnowledgeBaseCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is KnowledgeBaseCreateResponse &&
    ...
    override fun toString() =
        "KnowledgeBaseCreateResponse{knowledgeBase=$knowledgeBase, additionalProperties=$additionalProperties}"
}
