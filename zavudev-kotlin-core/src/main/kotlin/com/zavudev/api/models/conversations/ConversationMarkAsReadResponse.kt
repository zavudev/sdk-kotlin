...
class ConversationMarkAsReadResponse
...
private constructor(
    ...
    /** A builder for [ConversationMarkAsReadResponse]. */
    class Builder internal constructor() {

        private var conversation: JsonField<Conversation>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(conversationMarkAsReadResponse: ConversationMarkAsReadResponse) = apply {
            conversation = conversationMarkAsReadResponse.conversation
            additionalProperties =
                conversationMarkAsReadResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConversationMarkAsReadResponse].
         *
         ...
         */
        fun build(): ConversationMarkAsReadResponse =
            ConversationMarkAsReadResponse(
     ...
     *   expected type.
     */
    fun validate(): ConversationMarkAsReadResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConversationMarkAsReadResponse &&
    ...
    override fun toString() =
        "ConversationMarkAsReadResponse{conversation=$conversation, additionalProperties=$additionalProperties}"
}
