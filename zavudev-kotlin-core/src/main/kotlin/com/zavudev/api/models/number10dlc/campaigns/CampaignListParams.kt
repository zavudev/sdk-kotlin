...
private constructor(
    ...
    companion object {
        ...
        fun none(): CampaignListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(campaignListParams: CampaignListParams) = apply {
            ...
            cursor = campaignListParams.cursor
    ...
    override fun hashCode(): Int =
        Objects.hash(brandId, cursor, limit, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "CampaignListParams{brandId=$brandId, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
