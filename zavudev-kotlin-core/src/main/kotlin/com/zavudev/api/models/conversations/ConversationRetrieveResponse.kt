...
class ConversationRetrieveResponse
...
private constructor(
    ...
    ) : this(conversation, mutableMapOf())

    /**
     * An inbox thread with one contact. A conversation groups every message exchanged with that
     * contact across channels, so a contact who writes on WhatsApp and later by email stays in one
     * thread.
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConversationRetrieveResponse].
         *
    ...
    /** A builder for [ConversationRetrieveResponse]. */
    class Builder internal constructor() {

        private var conversation: JsonField<Conversation>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(conversationRetrieveResponse: ConversationRetrieveResponse) = apply {
            conversation = conversationRetrieveResponse.conversation
            additionalProperties = conversationRetrieveResponse.additionalProperties.toMutableMap()
        }

        /**
         * An inbox thread with one contact. A conversation groups every message exchanged with that
         * contact across channels, so a contact who writes on WhatsApp and later by email stays in
         * one thread.
         */
        ...
        /**
         * Returns an immutable instance of [ConversationRetrieveResponse].
         *
         ...
         */
        fun build(): ConversationRetrieveResponse =
     ...
     *   expected type.
     */
    fun validate(): ConversationRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
     ...
     */
    internal fun validity(): Int = (conversation.asKnown()?.validity() ?: 0)
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(conversation: Conversation) = apply {
                id = conversation.id
                channels = conversation.channels.map { it.toMutableList() }
             ...
             * business-scoped user ID (BSUID), a numeric chat ID (Telegram/Instagram/Messenger), or
             * a group JID. It is not always a phone number, so do not parse it as one.
             */
        ...
        private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("at")
                @ExcludeMissing
                at: JsonField<OffsetDateTime> = JsonMissing.of(),
        ...
        private constructor(
             ...
             *
             * Unlike [participantCount], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("participantCount")
            @ExcludeMissing
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 */
                fun build(): Whatsapp =
                    Whatsapp(bsuid, username, additionalProperties.toMutableMap())
            }
            ...
            private val hashCode: Int by lazy {
                Objects.hash(bsuid, username, additionalProperties)
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConversationRetrieveResponse &&
            conversation == other.conversation &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(conversation, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ConversationRetrieveResponse{conversation=$conversation, additionalProperties=$additionalProperties}"
}
