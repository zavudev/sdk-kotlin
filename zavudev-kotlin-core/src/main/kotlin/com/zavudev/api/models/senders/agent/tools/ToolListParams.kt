...
private constructor(
    ...
    companion object {
        ...
        fun none(): ToolListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(toolListParams: ToolListParams) = apply {
            senderId = toolListParams.senderId
            cursor = toolListParams.cursor
            enabled = toolListParams.enabled
    ...
    override fun toString() =
        "ToolListParams{senderId=$senderId, cursor=$cursor, enabled=$enabled, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
