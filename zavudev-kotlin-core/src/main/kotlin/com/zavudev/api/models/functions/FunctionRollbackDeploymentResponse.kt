...
class FunctionRollbackDeploymentResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val deployment: JsonField<Deployment>,
    private val previousDraft: JsonValue,
    private val rolledBackToVersion: JsonField<Long>,
    ...
    private constructor(
        ...
        @JsonProperty("previousDraft") @ExcludeMissing previousDraft: JsonValue = JsonMissing.of(),
        @JsonProperty("rolledBackToVersion")
        @ExcludeMissing
        rolledBackToVersion: JsonField<Long> = JsonMissing.of(),
    ) : this(deployment, previousDraft, rolledBackToVersion, mutableMapOf())
     ...
     * ```kotlin
     * val myObject: MyClass = functionRollbackDeploymentResponse.previousDraft().convert(MyClass::class.java)
     * ```
     */
    @JsonProperty("previousDraft") @ExcludeMissing fun _previousDraft(): JsonValue = previousDraft

    /**
     * @throws ZavudevInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun rolledBackToVersion(): Long? = rolledBackToVersion.getNullable("rolledBackToVersion")
    ...
    /**
     * Returns the raw JSON value of [rolledBackToVersion].
     *
     * Unlike [rolledBackToVersion], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("rolledBackToVersion")
    @ExcludeMissing
    fun _rolledBackToVersion(): JsonField<Long> = rolledBackToVersion
    ...
    /** A builder for [FunctionRollbackDeploymentResponse]. */
    class Builder internal constructor() {

        private var deployment: JsonField<Deployment>? = null
        private var previousDraft: JsonValue = JsonMissing.of()
        private var rolledBackToVersion: JsonField<Long> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(functionRollbackDeploymentResponse: FunctionRollbackDeploymentResponse) =
            apply {
                deployment = functionRollbackDeploymentResponse.deployment
                previousDraft = functionRollbackDeploymentResponse.previousDraft
                rolledBackToVersion = functionRollbackDeploymentResponse.rolledBackToVersion
                additionalProperties =
                    functionRollbackDeploymentResponse.additionalProperties.toMutableMap()
            }
        ...
        /** The draft that was replaced, so a UI can offer to restore it. */
        fun previousDraft(previousDraft: JsonValue) = apply { this.previousDraft = previousDraft }

        fun rolledBackToVersion(rolledBackToVersion: Long) =
            rolledBackToVersion(JsonField.of(rolledBackToVersion))

        /**
         * Sets [Builder.rolledBackToVersion] to an arbitrary JSON value.
         *
         * You should usually call [Builder.rolledBackToVersion] with a well-typed [Long] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rolledBackToVersion(rolledBackToVersion: JsonField<Long>) = apply {
        ...
        /**
         * Returns an immutable instance of [FunctionRollbackDeploymentResponse].
         *
         ...
         */
        fun build(): FunctionRollbackDeploymentResponse =
            FunctionRollbackDeploymentResponse(
     ...
     *   expected type.
     */
    fun validate(): FunctionRollbackDeploymentResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (deployment.asKnown()?.validity() ?: 0) +
            (if (rolledBackToVersion.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FunctionRollbackDeploymentResponse &&
            deployment == other.deployment &&
            previousDraft == other.previousDraft &&
            rolledBackToVersion == other.rolledBackToVersion &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy {
        Objects.hash(deployment, previousDraft, rolledBackToVersion, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "FunctionRollbackDeploymentResponse{deployment=$deployment, previousDraft=$previousDraft, rolledBackToVersion=$rolledBackToVersion, additionalProperties=$additionalProperties}"
}
