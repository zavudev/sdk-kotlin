...
private constructor(
    ...
    private constructor(
        ...
        ) : this(name, environment, permissions, mutableMapOf())
         ...
         *   server responded with an unexpected value).
         */
        fun environment(): Environment? = environment.getNullable("environment")
        ...
        private val hashCode: Int by lazy {
            Objects.hash(name, environment, permissions, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, environment=$environment, permissions=$permissions, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "ApiKeyCreateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
