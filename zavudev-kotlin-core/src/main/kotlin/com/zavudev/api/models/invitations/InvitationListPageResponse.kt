...
private constructor(
    private val items: JsonField<List<Invitation>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<Invitation>> = JsonMissing.of(),
     ...
     */
    fun items(): List<Invitation> = items.getRequired("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<Invitation>> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: JsonField<MutableList<Invitation>>? = null
        private var nextCursor: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(invitationListPageResponse: InvitationListPageResponse) = apply {
            items = invitationListPageResponse.items.map { it.toMutableList() }
        ...
        fun items(items: List<Invitation>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<Invitation>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<Invitation>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [Invitation] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: Invitation) = apply {
            items =
    ...
    override fun toString() =
        "InvitationListPageResponse{items=$items, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
