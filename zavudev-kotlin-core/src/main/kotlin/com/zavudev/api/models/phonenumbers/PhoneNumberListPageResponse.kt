...
private constructor(
    private val items: JsonField<List<OwnedPhoneNumber>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<OwnedPhoneNumber>> = JsonMissing.of(),
     ...
     */
    fun items(): List<OwnedPhoneNumber> = items.getRequired("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<OwnedPhoneNumber>> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: JsonField<MutableList<OwnedPhoneNumber>>? = null
        private var nextCursor: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(phoneNumberListPageResponse: PhoneNumberListPageResponse) = apply {
            items = phoneNumberListPageResponse.items.map { it.toMutableList() }
            nextCursor = phoneNumberListPageResponse.nextCursor
            additionalProperties = phoneNumberListPageResponse.additionalProperties.toMutableMap()
        }

        fun items(items: List<OwnedPhoneNumber>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<OwnedPhoneNumber>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<OwnedPhoneNumber>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [OwnedPhoneNumber] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: OwnedPhoneNumber) = apply {
            items =
    ...
    override fun toString() =
        "PhoneNumberListPageResponse{items=$items, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
