...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(toolRetrieveResponse: ToolRetrieveResponse) = apply {
            tool = toolRetrieveResponse.tool
        ...
        fun build(): ToolRetrieveResponse =
            ToolRetrieveResponse(checkRequired("tool", tool), additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "ToolRetrieveResponse{tool=$tool, additionalProperties=$additionalProperties}"
}
