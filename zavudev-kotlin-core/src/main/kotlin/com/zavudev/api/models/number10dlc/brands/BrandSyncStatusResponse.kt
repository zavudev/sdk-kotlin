...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrandSyncStatusResponse].
         *
    ...
    /** A builder for [BrandSyncStatusResponse]. */
    class Builder internal constructor() {

        private var brand: JsonField<TenDlcBrand>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(brandSyncStatusResponse: BrandSyncStatusResponse) = apply {
            brand = brandSyncStatusResponse.brand
            additionalProperties = brandSyncStatusResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrandSyncStatusResponse].
         *
         ...
         */
        fun build(): BrandSyncStatusResponse =
     ...
     *   expected type.
     */
    fun validate(): BrandSyncStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrandSyncStatusResponse &&
            brand == other.brand &&
    ...
    override fun toString() =
        "BrandSyncStatusResponse{brand=$brand, additionalProperties=$additionalProperties}"
}
