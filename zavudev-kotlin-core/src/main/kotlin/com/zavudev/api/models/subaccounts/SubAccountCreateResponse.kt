...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubAccountCreateResponse].
         *
    ...
    /** A builder for [SubAccountCreateResponse]. */
    class Builder internal constructor() {

        private var subAccount: JsonField<SubAccount>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(subAccountCreateResponse: SubAccountCreateResponse) = apply {
            subAccount = subAccountCreateResponse.subAccount
            additionalProperties = subAccountCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubAccountCreateResponse].
         *
         ...
         */
        fun build(): SubAccountCreateResponse =
     ...
     *   expected type.
     */
    fun validate(): SubAccountCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubAccountCreateResponse &&
    ...
    override fun toString() =
        "SubAccountCreateResponse{subAccount=$subAccount, additionalProperties=$additionalProperties}"
}
