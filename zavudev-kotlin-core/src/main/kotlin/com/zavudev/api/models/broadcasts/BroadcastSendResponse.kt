...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BroadcastSendResponse].
         *
    ...
    /** A builder for [BroadcastSendResponse]. */
    class Builder internal constructor() {

        private var broadcast: JsonField<Broadcast>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(broadcastSendResponse: BroadcastSendResponse) = apply {
            broadcast = broadcastSendResponse.broadcast
            additionalProperties = broadcastSendResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BroadcastSendResponse].
         *
         ...
         */
        fun build(): BroadcastSendResponse =
     ...
     *   expected type.
     */
    fun validate(): BroadcastSendResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BroadcastSendResponse &&
    ...
    override fun toString() =
        "BroadcastSendResponse{broadcast=$broadcast, additionalProperties=$additionalProperties}"
}
