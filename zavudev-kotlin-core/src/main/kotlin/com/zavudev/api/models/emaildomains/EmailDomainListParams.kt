...
private constructor(
    ...
    companion object {
        ...
        fun none(): EmailDomainListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): EmailDomainListParams =
            EmailDomainListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "EmailDomainListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
