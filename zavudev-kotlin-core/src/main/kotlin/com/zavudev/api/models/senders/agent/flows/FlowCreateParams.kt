...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FlowCreateParams].
         *
    ...
    /** A builder for [FlowCreateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(flowCreateParams: FlowCreateParams) = apply {
            senderId = flowCreateParams.senderId
            body = flowCreateParams.body.toBuilder()
            additionalHeaders = flowCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = flowCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FlowCreateParams].
         *
    ...
    private constructor(
        ...
        ) : this(name, steps, trigger, description, enabled, priority, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(name, steps, trigger, description, enabled, priority, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, steps=$steps, trigger=$trigger, description=$description, enabled=$enabled, priority=$priority, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FlowCreateParams &&
    ...
    override fun toString() =
        "FlowCreateParams{senderId=$senderId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
