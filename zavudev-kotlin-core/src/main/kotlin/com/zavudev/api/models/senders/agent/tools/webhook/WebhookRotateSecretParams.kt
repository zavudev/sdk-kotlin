 ...
 * with no overlap, so update your endpoint first. The tool keeps its id, so flows that reference it
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookRotateSecretParams: WebhookRotateSecretParams) = apply {
            senderId = webhookRotateSecretParams.senderId
            toolId = webhookRotateSecretParams.toolId
    ...
    override fun toString() =
        "WebhookRotateSecretParams{senderId=$senderId, toolId=$toolId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
