...
class RegulatoryDocumentCreateResponse
...
private constructor(
    ...
    /** A builder for [RegulatoryDocumentCreateResponse]. */
    class Builder internal constructor() {

        private var document: JsonField<RegulatoryDocument>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(regulatoryDocumentCreateResponse: RegulatoryDocumentCreateResponse) =
            apply {
                document = regulatoryDocumentCreateResponse.document
                additionalProperties =
                    regulatoryDocumentCreateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RegulatoryDocumentCreateResponse].
         *
         ...
         */
        fun build(): RegulatoryDocumentCreateResponse =
            RegulatoryDocumentCreateResponse(
     ...
     *   expected type.
     */
    fun validate(): RegulatoryDocumentCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RegulatoryDocumentCreateResponse &&
    ...
    override fun toString() =
        "RegulatoryDocumentCreateResponse{document=$document, additionalProperties=$additionalProperties}"
}
