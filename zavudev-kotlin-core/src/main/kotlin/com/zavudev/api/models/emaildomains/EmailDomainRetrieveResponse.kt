...
class EmailDomainRetrieveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailDomainRetrieveResponse].
         *
    ...
    /** A builder for [EmailDomainRetrieveResponse]. */
    class Builder internal constructor() {

        private var domain: JsonField<Domain>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(emailDomainRetrieveResponse: EmailDomainRetrieveResponse) = apply {
            domain = emailDomainRetrieveResponse.domain
            additionalProperties = emailDomainRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailDomainRetrieveResponse].
         *
         ...
         */
        fun build(): EmailDomainRetrieveResponse =
     ...
     *   expected type.
     */
    fun validate(): EmailDomainRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailDomainRetrieveResponse &&
            domain == other.domain &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "EmailDomainRetrieveResponse{domain=$domain, additionalProperties=$additionalProperties}"
}
