...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BroadcastUpdateResponse].
         *
    ...
    /** A builder for [BroadcastUpdateResponse]. */
    class Builder internal constructor() {

        private var broadcast: JsonField<Broadcast>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(broadcastUpdateResponse: BroadcastUpdateResponse) = apply {
            broadcast = broadcastUpdateResponse.broadcast
            additionalProperties = broadcastUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BroadcastUpdateResponse].
         *
         ...
         */
        fun build(): BroadcastUpdateResponse =
     ...
     *   expected type.
     */
    fun validate(): BroadcastUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BroadcastUpdateResponse &&
    ...
    override fun toString() =
        "BroadcastUpdateResponse{broadcast=$broadcast, additionalProperties=$additionalProperties}"
}
