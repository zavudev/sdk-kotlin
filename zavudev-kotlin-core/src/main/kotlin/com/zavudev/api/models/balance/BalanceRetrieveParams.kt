...
/**
 * Get balance for the API key's team. If the API key belongs to a sub-account, also includes the
 * sub-account's total spending and credit limit.
 */
...
private constructor(
    ...
    companion object {
        ...
        fun none(): BalanceRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): BalanceRetrieveParams =
            BalanceRetrieveParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "BalanceRetrieveParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
