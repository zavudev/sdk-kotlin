...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(brandUpdateResponse: BrandUpdateResponse) = apply {
            brand = brandUpdateResponse.brand
        ...
        fun build(): BrandUpdateResponse =
            BrandUpdateResponse(checkRequired("brand", brand), additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrandUpdateResponse &&
            brand == other.brand &&
    ...
    override fun toString() =
        "BrandUpdateResponse{brand=$brand, additionalProperties=$additionalProperties}"
}
