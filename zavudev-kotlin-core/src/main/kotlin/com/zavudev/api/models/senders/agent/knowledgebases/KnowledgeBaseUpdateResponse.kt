...
class KnowledgeBaseUpdateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [KnowledgeBaseUpdateResponse].
         *
    ...
    /** A builder for [KnowledgeBaseUpdateResponse]. */
    class Builder internal constructor() {

        private var knowledgeBase: JsonField<AgentKnowledgeBase>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(knowledgeBaseUpdateResponse: KnowledgeBaseUpdateResponse) = apply {
            knowledgeBase = knowledgeBaseUpdateResponse.knowledgeBase
            additionalProperties = knowledgeBaseUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [KnowledgeBaseUpdateResponse].
         *
         ...
         */
        fun build(): KnowledgeBaseUpdateResponse =
     ...
     *   expected type.
     */
    fun validate(): KnowledgeBaseUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is KnowledgeBaseUpdateResponse &&
    ...
    override fun toString() =
        "KnowledgeBaseUpdateResponse{knowledgeBase=$knowledgeBase, additionalProperties=$additionalProperties}"
}
