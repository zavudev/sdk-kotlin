...
class DocumentRetrieveDocumentResponse
...
private constructor(
    ...
    /** A builder for [DocumentRetrieveDocumentResponse]. */
    class Builder internal constructor() {

        private var document: JsonField<AgentDocument>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(documentRetrieveDocumentResponse: DocumentRetrieveDocumentResponse) =
            apply {
                document = documentRetrieveDocumentResponse.document
                additionalProperties =
                    documentRetrieveDocumentResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [DocumentRetrieveDocumentResponse].
         *
         ...
         */
        fun build(): DocumentRetrieveDocumentResponse =
            DocumentRetrieveDocumentResponse(
     ...
     *   expected type.
     */
    fun validate(): DocumentRetrieveDocumentResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DocumentRetrieveDocumentResponse &&
    ...
    override fun toString() =
        "DocumentRetrieveDocumentResponse{document=$document, additionalProperties=$additionalProperties}"
}
