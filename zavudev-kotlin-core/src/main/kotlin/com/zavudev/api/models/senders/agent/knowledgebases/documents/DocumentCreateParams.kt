...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(documentCreateParams: DocumentCreateParams) = apply {
            senderId = documentCreateParams.senderId
            kbId = documentCreateParams.kbId
    ...
    override fun toString() =
        "DocumentCreateParams{senderId=$senderId, kbId=$kbId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
