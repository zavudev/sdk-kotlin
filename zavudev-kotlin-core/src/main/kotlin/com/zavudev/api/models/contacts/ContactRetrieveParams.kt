...
private constructor(
    ...
    companion object {
        ...
        fun none(): ContactRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(contactRetrieveParams: ContactRetrieveParams) = apply {
            contactId = contactRetrieveParams.contactId
    ...
    override fun toString() =
        "ContactRetrieveParams{contactId=$contactId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
