...
/**
 * Make the agent answer on this sender. An agent can serve several senders; a sender answers with
 * at most one agent, so connecting one that is already in use returns `400` naming the agent that
 * holds it.
 */
class SenderConnectParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SenderConnectParams].
         *
    ...
    /** A builder for [SenderConnectParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(senderConnectParams: SenderConnectParams) = apply {
            agentId = senderConnectParams.agentId
            body = senderConnectParams.body.toBuilder()
            additionalHeaders = senderConnectParams.additionalHeaders.toBuilder()
            additionalQueryParams = senderConnectParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SenderConnectParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SenderConnectParams &&
    ...
    override fun toString() =
        "SenderConnectParams{agentId=$agentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
