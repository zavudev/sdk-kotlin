 ...
 * Drafts can be created, edited and kept without either. Every send path — dashboard, API and CLI
 * alike — enforces both, returning `403` with code `kyc_required` or `kyb_required` for whichever
 * is outstanding.
 *
