...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BroadcastCancelResponse].
         *
    ...
    /** A builder for [BroadcastCancelResponse]. */
    class Builder internal constructor() {

        private var broadcast: JsonField<Broadcast>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(broadcastCancelResponse: BroadcastCancelResponse) = apply {
            broadcast = broadcastCancelResponse.broadcast
            additionalProperties = broadcastCancelResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BroadcastCancelResponse].
         *
         ...
         */
        fun build(): BroadcastCancelResponse =
     ...
     *   expected type.
     */
    fun validate(): BroadcastCancelResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BroadcastCancelResponse &&
    ...
    override fun toString() =
        "BroadcastCancelResponse{broadcast=$broadcast, additionalProperties=$additionalProperties}"
}
