...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FlowDuplicateResponse].
         *
    ...
    /** A builder for [FlowDuplicateResponse]. */
    class Builder internal constructor() {

        private var flow: JsonField<AgentFlow>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(flowDuplicateResponse: FlowDuplicateResponse) = apply {
            flow = flowDuplicateResponse.flow
            additionalProperties = flowDuplicateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FlowDuplicateResponse].
         *
         ...
         */
        fun build(): FlowDuplicateResponse =
            FlowDuplicateResponse(checkRequired("flow", flow), additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): FlowDuplicateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FlowDuplicateResponse &&
            flow == other.flow &&
    ...
    override fun toString() =
        "FlowDuplicateResponse{flow=$flow, additionalProperties=$additionalProperties}"
}
