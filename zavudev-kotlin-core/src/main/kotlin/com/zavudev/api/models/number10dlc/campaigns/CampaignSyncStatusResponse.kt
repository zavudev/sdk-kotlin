...
class CampaignSyncStatusResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CampaignSyncStatusResponse].
         *
    ...
    /** A builder for [CampaignSyncStatusResponse]. */
    class Builder internal constructor() {

        private var campaign: JsonField<TenDlcCampaign>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(campaignSyncStatusResponse: CampaignSyncStatusResponse) = apply {
            campaign = campaignSyncStatusResponse.campaign
            additionalProperties = campaignSyncStatusResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CampaignSyncStatusResponse].
         *
         ...
         */
        fun build(): CampaignSyncStatusResponse =
     ...
     *   expected type.
     */
    fun validate(): CampaignSyncStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CampaignSyncStatusResponse &&
    ...
    override fun toString() =
        "CampaignSyncStatusResponse{campaign=$campaign, additionalProperties=$additionalProperties}"
}
