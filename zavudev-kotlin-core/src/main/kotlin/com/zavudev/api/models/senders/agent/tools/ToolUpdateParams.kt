...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(toolUpdateParams: ToolUpdateParams) = apply {
            senderId = toolUpdateParams.senderId
    ...
    private constructor(
        ...
        ) : this(description, enabled, name, parameters, webhookSecret, webhookUrl, mutableMapOf())
         ...
         *   server responded with an unexpected value).
         */
        fun parameters(): ToolParameters? = parameters.getNullable("parameters")
        ...
        class Builder internal constructor() {
            ...
            private var parameters: JsonField<ToolParameters> = JsonMissing.of()
            ...
            fun webhookSecret(webhookSecret: String?) =
                webhookSecret(JsonField.ofNullable(webhookSecret))
        ...
        override fun toString() =
            "Body{description=$description, enabled=$enabled, name=$name, parameters=$parameters, webhookSecret=$webhookSecret, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "ToolUpdateParams{senderId=$senderId, toolId=$toolId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
