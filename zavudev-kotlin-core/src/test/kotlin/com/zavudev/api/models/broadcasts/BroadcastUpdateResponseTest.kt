...
internal class BroadcastUpdateResponseTest {

    @Test
    fun create() {
        val broadcastUpdateResponse =
            BroadcastUpdateResponse.builder()
                .broadcast(
                    Broadcast.builder()
                        .id("brd_abc123")
        ...
        assertThat(broadcastUpdateResponse.broadcast())
            .isEqualTo(
                Broadcast.builder()
                    .id("brd_abc123")
                    .channel(BroadcastChannel.SMART)
    ...
    fun roundtrip() {
        ...
        val roundtrippedBroadcastUpdateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(broadcastUpdateResponse),
                jacksonTypeRef<BroadcastUpdateResponse>(),
            )

        assertThat(roundtrippedBroadcastUpdateResponse).isEqualTo(broadcastUpdateResponse)
    }
}
