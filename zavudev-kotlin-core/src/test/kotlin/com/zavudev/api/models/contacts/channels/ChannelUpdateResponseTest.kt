...
internal class ChannelUpdateResponseTest {

    @Test
    fun create() {
        val channelUpdateResponse =
            ChannelUpdateResponse.builder()
                .channel(
        ...
        assertThat(channelUpdateResponse.channel())
            .isEqualTo(
                ContactChannel.builder()
                    .id("id")
                    .channel(ContactChannel.Channel.SMS)
    ...
    fun roundtrip() {
        ...
        val roundtrippedChannelUpdateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(channelUpdateResponse),
                jacksonTypeRef<ChannelUpdateResponse>(),
            )

        assertThat(roundtrippedChannelUpdateResponse).isEqualTo(channelUpdateResponse)
    }
}
