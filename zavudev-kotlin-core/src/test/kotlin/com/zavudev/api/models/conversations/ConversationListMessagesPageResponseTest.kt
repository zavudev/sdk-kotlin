...
internal class ConversationListMessagesPageResponseTest {

    @Test
    fun create() {
        val conversationListMessagesPageResponse =
            ConversationListMessagesPageResponse.builder()
                .addItem(
                    Message.builder()
        ...
        assertThat(conversationListMessagesPageResponse.items())
            .containsExactly(
                Message.builder()
                    .id("jd7x2k3m4n5p6q7r8s9t0")
                    .channel(Channel.AUTO)
        ...
        assertThat(conversationListMessagesPageResponse.nextCursor()).isEqualTo("nextCursor")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedConversationListMessagesPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(conversationListMessagesPageResponse),
                jacksonTypeRef<ConversationListMessagesPageResponse>(),
            )

        assertThat(roundtrippedConversationListMessagesPageResponse)
            .isEqualTo(conversationListMessagesPageResponse)
    }
}
