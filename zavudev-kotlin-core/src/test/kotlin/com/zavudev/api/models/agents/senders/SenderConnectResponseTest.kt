...
internal class SenderConnectResponseTest {

    @Test
    fun create() {
        val senderConnectResponse =
            SenderConnectResponse.builder()
                .agent(
                    Agent.builder()
                        .id("agent_abc123")
        ...
        assertThat(senderConnectResponse.agent())
            .isEqualTo(
                Agent.builder()
                    .id("agent_abc123")
                    .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedSenderConnectResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(senderConnectResponse),
                jacksonTypeRef<SenderConnectResponse>(),
            )

        assertThat(roundtrippedSenderConnectResponse).isEqualTo(senderConnectResponse)
    }
}
