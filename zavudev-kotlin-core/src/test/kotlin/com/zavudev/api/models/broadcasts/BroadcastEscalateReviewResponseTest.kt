...
internal class BroadcastEscalateReviewResponseTest {

    @Test
    fun create() {
        val broadcastEscalateReviewResponse =
            BroadcastEscalateReviewResponse.builder()
                .broadcast(
                    Broadcast.builder()
                        .id("brd_abc123")
        ...
        assertThat(broadcastEscalateReviewResponse.broadcast())
            .isEqualTo(
                Broadcast.builder()
                    .id("brd_abc123")
                    .channel(BroadcastChannel.SMART)
    ...
    fun roundtrip() {
        ...
        val roundtrippedBroadcastEscalateReviewResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(broadcastEscalateReviewResponse),
                jacksonTypeRef<BroadcastEscalateReviewResponse>(),
            )

        assertThat(roundtrippedBroadcastEscalateReviewResponse)
            .isEqualTo(broadcastEscalateReviewResponse)
    }
}
