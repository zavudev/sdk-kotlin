...
internal class BroadcastCancelResponseTest {

    @Test
    fun create() {
        val broadcastCancelResponse =
            BroadcastCancelResponse.builder()
                .broadcast(
                    Broadcast.builder()
                        .id("brd_abc123")
        ...
        assertThat(broadcastCancelResponse.broadcast())
            .isEqualTo(
                Broadcast.builder()
                    .id("brd_abc123")
                    .channel(BroadcastChannel.SMART)
    ...
    fun roundtrip() {
        ...
        val roundtrippedBroadcastCancelResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(broadcastCancelResponse),
                jacksonTypeRef<BroadcastCancelResponse>(),
            )

        assertThat(roundtrippedBroadcastCancelResponse).isEqualTo(broadcastCancelResponse)
    }
}
