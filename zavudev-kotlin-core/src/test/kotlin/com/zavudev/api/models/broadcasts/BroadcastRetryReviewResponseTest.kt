...
internal class BroadcastRetryReviewResponseTest {

    @Test
    fun create() {
        val broadcastRetryReviewResponse =
            BroadcastRetryReviewResponse.builder()
                .broadcast(
                    Broadcast.builder()
                        .id("brd_abc123")
        ...
        assertThat(broadcastRetryReviewResponse.broadcast())
            .isEqualTo(
                Broadcast.builder()
                    .id("brd_abc123")
                    .channel(BroadcastChannel.SMART)
    ...
    fun roundtrip() {
        ...
        val roundtrippedBroadcastRetryReviewResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(broadcastRetryReviewResponse),
                jacksonTypeRef<BroadcastRetryReviewResponse>(),
            )

        assertThat(roundtrippedBroadcastRetryReviewResponse).isEqualTo(broadcastRetryReviewResponse)
    }
}
