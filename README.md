...
[![Maven Central](https://img.shields.io/maven-central/v/com.zavudev.api/zavudev-kotlin)](https://central.sonatype.com/artifact/com.zavudev.api/zavudev-kotlin/0.2.0)
[![javadoc](https://javadoc.io/badge2/com.zavudev.api/zavudev-kotlin/javadoc.svg)](https://javadoc.io/doc/com.zavudev.api/zavudev-kotlin/0.2.0)
...
The REST API documentation can be found on [docs.zavu.dev](https://docs.zavu.dev). KDocs are available on [javadoc.io](https://javadoc.io/doc/com.zavudev.api/zavudev-kotlin/0.2.0).
...
```kotlin
implementation("com.zavudev.api:zavudev-kotlin:0.2.0")
```
